...
We are going to use Axios to make the AJAX Request, so we have to install and import Axios.

**Tasks**

- Install Axios through `npm` and import it in your component.
